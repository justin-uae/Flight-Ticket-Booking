        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <div className="flex items-center gap-3">
              <Link
                to="/register"
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 py-2.5 rounded-full transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Connect With Us
              </Link>
            </div>
            ...
            <div className="flex flex-col space-y-1 pt-4">
              ...
              <div className="border-t border-gray-200 pt-4 mt-4 px-4 space-y-3">
                <>
                  <Link
                    to="/login"
                    className="block text-center border-2 border-gray-400 hover:border-blue-600 hover:bg-blue-50 text-gray-800 font-bold py-3 rounded-full transition-all"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Connect With Us now
                  </Link>
                  ...
                  <Link
                    to="/register"
                    className="block text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-full shadow-lg"
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Book Now
                  </Link>
