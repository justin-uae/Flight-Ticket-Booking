    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="relative bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 pt-20 sm:pt-24 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 bg-purple-200 rounded-full blur-3xl opacity-20"></div>
                <div className="absolute bottom-0 left-0 w-64 sm:w-96 h-64 sm:h-96 bg-blue-200 rounded-full blur-3xl opacity-20"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
                    <div className="group p-5 sm:p-6 md:p-7 bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-xl sm:rounded-2xl hover:shadow-2xl transition-all transform hover:-translate-y-2 hover:border-purple-300">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl flex items-center justify-center mb-3 sm:mb-4 shadow-lg group-hover:scale-110 transition-transform">
            ...
            <div className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-purple-600 py-8 sm:py-12 md:py-16 px-4 sm:px-6 my-6 sm:my-8 overflow-hidden">
                {/* Decorative patterns */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
                <div className="text-center mb-8 sm:mb-12 md:mb-16">
                    <div className="inline-flex items-center gap-2 bg-gray-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-3 sm:mb-4 border-2 border-gray-200">
                        <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-600" />
                        <span className="text-purple-700 text-xs sm:text-sm font-bold uppercase tracking-wider">Benefits</span>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
                    <div className="flex gap-3 sm:gap-4 md:gap-5 p-5 sm:p-6 md:p-7 bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 rounded-xl sm:rounded-2xl hover:shadow-xl transition-all hover:border-purple-300">
                        <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center shadow-lg">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 py-8 sm:py-12 md:py-16 px-4 sm:px-6 relative overflow-hidden">
                {/* Decorative elements */}
                <div className="absolute top-0 right-0 w-48 sm:w-64 h-48 sm:h-64 bg-purple-500/10 rounded-full blur-3xl"></div>
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-transparent mb-2 sm:mb-3">500+</h3>
                            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-300 font-bold uppercase tracking-wider">Airlines</p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-transparent mb-2 sm:mb-3">100K+</h3>
                        ...
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-transparent mb-2 sm:mb-3">4.9★</h3>
                            <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-300 font-bold uppercase tracking-wider">Average Rating</p>
                        </div>
                        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 text-center hover:bg-white/10 transition-all">
                            <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-purple-500 to-blue-600 bg-clip-text text-transparent mb-2 sm:mb-3">24/7</h3>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
                <div className="relative bg-gradient-to-br from-purple-600 via-blue-600 to-purple-600 rounded-2xl sm:rounded-3xl p-8 sm:p-10 md:p-14 lg:p-16 text-center text-white shadow-2xl overflow-hidden">
                    {/* Decorative elements */}
                    ...
                    <div className="relative z-10">
                        ...
                        <Link
                            to="/"
                            className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 bg-white text-purple-700 rounded-full font-black text-base sm:text-lg md:text-xl hover:shadow-2xl transform hover:scale-105 transition-all"
                        >
